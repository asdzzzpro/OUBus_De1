...
public class FXMLThemChuyenDiController implements Initializable {
    ...
    @FXML private DatePicker ngayXuatPhat;
    ...
    public void themChuyenDi(ActionEvent event){
        ChuyenXe c = new ChuyenXe(Integer.parseInt(this.maChuyenXe.getText()),Integer.parseInt(this.maXe.getText()),this.ngayXuatPhat.getEditor().getText(),Integer.parseInt(this.giaVe.getText()), this.txtDiemDi.getText(),this.textDiemDen.getText());
